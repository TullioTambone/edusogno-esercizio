<div id="sfondo">
    <div id="sfera-dx">
        <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" viewBox="0 0 181 181" fill="none">
            <circle cx="90.5" cy="90.5" r="90.5" fill="white"/>
        </svg>
    </div>
    <div id="sfera-sx">
        <svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 181 181" fill="none">
            <circle cx="0" cy="90.5" r="90.5" fill="white"/>
        </svg>
    </div>
    <div id="onda-superiore">
        <svg xmlns="http://www.w3.org/2000/svg" width="1544" height="152" viewBox="0 0 1440 128" fill="none">
    ...
    <div id="onda-intermedia">
        <svg xmlns="http://www.w3.org/2000/svg" width="1557.836" height="433" viewBox="0 0 1440 433" fill="none">
    ...
    <div id="onda-inferiore">
        <svg xmlns="http://www.w3.org/2000/svg" width="2961" height="226" viewBox="0 0 1440 226" fill="none">
